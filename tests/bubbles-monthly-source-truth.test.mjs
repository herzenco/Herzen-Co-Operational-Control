...
import { dateFromBorderedFile, storageObjectName, validateMonthFiles } from "../scripts/bubbles-monthly-source-truth.mjs";
...
test("date-prefixed bordered exports preserve date mapping", () => {
  ...
  assert.equal(storageObjectName("2026-08-27", "2026-08-27_] Edited.jpg"), "day-27.jpg");
});
